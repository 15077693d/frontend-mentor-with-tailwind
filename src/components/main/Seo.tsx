...
const defaultMeta = {
  title: 'Frontend Mentor with Tailwind CSS',
  siteName: 'Frontend Mentor with Tailwind CSS',
  description: 'A frontend mentor exercises collection coding in Tailwind CSS',
  /** Without additional '/' on the end, e.g. https://theodorusclarence.com */
  url: 'https://www.oscaryiu.com/',
  type: 'website',
  robots: 'follow, index',
  /**
   ...
   */
  image: 'https://www.oscaryiu.com/static/images/socialBanner.png',
};
